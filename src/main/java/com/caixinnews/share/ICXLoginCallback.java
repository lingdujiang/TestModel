...
public class ICXLoginCallback implements IUiListener, WeiboAuthListener, RequestListener {
    ...
    public void onComplete(Object response) {
        final Tencent mTencent = Tencent.createInstance(com.caixinnews.share.Constants.APP_ID_QQ, mContext);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    UsersAPI usersAPI = new UsersAPI(mContext,
                            com.caixinnews.share.Constants.APP_KEY_WEIBO, mAccessToken);
